				...
				success:function(response){
					...
					if(response.result == "error"){
						...
						if(response.msg == "passwordError"){
							errorMessage = "密码错误";
							field = "oldPassword"
						}else if(response.msg == "passwordNotChange"){
							errorMessage = "密码与原密码相同";
							field = "newPassword"
						}
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-8">
				...
				<form action="" class="form-horizontal" style=""
					...
					<div class="form-group">
						<label for="" class="control-label col-md-4 col-sm-4"> 原密码: </label>
						<div class="col-md-8 col-sm-8">
					...
					<div class="form-group">
						<label for="" class="control-label col-md-4 col-sm-4"> 新密码: </label>
						<div class="col-md-8 col-sm-8">
					...
					<div class="form-group">
						<label for="" class="control-label col-md-4 col-sm-4"> 再一次新密码: </label>
