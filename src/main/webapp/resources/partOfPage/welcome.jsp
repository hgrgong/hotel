            ...
            <div class="col-md-10" style="text-align: center">
                <div class="col-md-4 col-sm-4">
                    <a href="javascript:void(0)" class="thumbnail shortcut"> <img
                        src="resources/images/room-icon.png" alt="房间查询"
                        class="img-rounded link" style="width: 150px; height: 150px;">
                        <div class="caption">
                            <h3 class="title">房间管理</h3>
                        </div>
                    </a>
                </div>
                <div class="col-md-4 col-sm-4">
                    <a href="javascript:void(0)" class="thumbnail shortcut"> <img
                        src="resources/images/user-icon.png" alt="用户查询"
                        class="img-rounded link" style="width: 150px; height: 150px;">
                        <div class="caption">
                ...
                <div class="col-md-4 col-sm-4">
                    <a href="javascript:void(0)" class="thumbnail shortcut"> <img
                        src="resources/images/order-icon.png" alt="账单查询"
                        class="img-rounded link" style="width: 150px; height: 150px;">
                        <div class="caption">
